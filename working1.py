...
def decrypt(encrypted_msg):
    ...
    # Proof:
    identity = np.zeros((2, 2))
    identity[0][0] = 1
    identity[1][1] = 1

    #len_check = len(encrypted_msg) % 2 == 0
    #if not len_check:
    #    encrypted_msg += "0"
...
def create_matrix_of_integers_from_string(string):
    ...
    ----------
    string : str
        string to be mapped into a matrix
    Return
    ------
    matrix
    """
